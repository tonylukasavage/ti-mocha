...
function build() {
	...
	if (index !== -1) {
		var titanium =  fs.readFileSync(C.UTIL_FILE, 'utf8') + fs.readFileSync(C.TITANIUM_FILE, 'utf8');
	...
	fs.writeFileSync(C.BUILD_FILE, fs.readFileSync(C.LICENSE_FILE, 'utf8') + content);
}
